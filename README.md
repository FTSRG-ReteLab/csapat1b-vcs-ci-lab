...
This is BBBB sample application for the verification laboratory.
...
When we read the exercise we decided to add some notes here.

These were:
* This.
* And a reuse of an existing image below:
![And an unique description.](doc/speed_example.png)